while True:
    print("==================================="
    "------------------------------------")
    print("Welcome to out smart Calculation Project!!")
    print(" Please Choose What you want to use")
    print("1. Baisec Calculator")
    ...
    again = input("Do you want to use SmartCalc again? (yes/no): ")
    if again.lower() != "yes":
        print("Thank you for using SmartCalc!") 
        break
